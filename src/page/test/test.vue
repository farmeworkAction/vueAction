<template>
  <div id="wrap">
    <div class="fixd-top1">
        <header>
            <div class="header-left"><a href="#" class="triangle-left"></a></div>
            <h1>美食</h1>
        </header>
    </div>
    <section id="elm-list">
...
header{
    ...
    .header-left{
        ...
        .triangle-left {
            ...
            margin: 6rem/$r;
            border-left: 4rem/$r solid;
            border-bottom: 4rem/$r solid;
            width: 18rem/$r;
            height: 18rem/$r;
...
section#elm-list{
    ...
    .nav{
        ...
        padding: 10rem/$r 0 ;
        font-size:32rem/$r;
        border-bottom: 1rem/$r solid #f4f4f4;
        background-color: #fff;
        display: flex;
        a{
            text-align: center;
            width: 33%;
            border-right: 1rem/$r solid #f4f4f4;
            .triangle-down {
                display: inline-block;
                margin: 6rem/$r 10rem/$r;
                width: 0;
                height: 0;
                border-left: 6rem/$r solid transparent;
                border-right: 6rem/$r solid transparent;
                border-top: 10rem/$r solid #333;
            }
        }
        .no-border{
            border-right: none;
